...
Filtering aims to provide a toolkit for digital signal processing, offering an infrastructure for digital filter design,
...
- [**MathNet.Filtering**](http://www.nuget.org/packages/MathNet.Filtering) - core package (MIT license)
- [**MathNet.Filtering.Kalman**](http://www.nuget.org/packages/MathNet.Filtering.Kalman/) - Kalman filter (LGPL license - until we can relicense)
