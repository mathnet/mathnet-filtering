<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteHeader.ascx.cs" Inherits="MathNet.Iridium.DocSite.Controls.DocSiteHeader" %>
...
<div id="docsite_header_title"><%= MathNet.Iridium.DocSite.DocSite.ProjectTitle %></div>
<div id="docsite_header_company"><%= MathNet.Iridium.DocSite.DocSite.ProjectCompany %></div>