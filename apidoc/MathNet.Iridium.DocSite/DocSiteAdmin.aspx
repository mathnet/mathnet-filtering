<%@ Page Language="C#" MasterPageFile="~/DocSite.Master" AutoEventWireup="true" CodeBehind="DocSiteAdmin.aspx.cs" Inherits="MathNet.Iridium.DocSite.DocSiteAdmin" Title="MathNet.Iridium.DocSite - Administration" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceholder" runat="server">
  ...
  <asp:ObjectDataSource runat="server" ID="statisticsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetStatisticsForBinding" />
	<asp:ObjectDataSource runat="server" ID="clientSettingsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	...
	<asp:ObjectDataSource runat="server" ID="searchSettingsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="keywordSettingsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="weightFactorsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
	<asp:ObjectDataSource runat="server" ID="additionalWeightsDataSource" TypeName="MathNet.Iridium.DocSite.DocSiteAdmin" SelectMethod="GetSettingsForBinding" UpdateMethod="UpdateSettings"
	                      DataObjectTypeName="DaveSexton.DocProject.DocSites.Configuration.DocSiteSettings, DaveSexton.DocProject.DocSites, Version=1.0.1.0, Culture=neutral, PublicKeyToken=af1a4bab65cc4ece" />
