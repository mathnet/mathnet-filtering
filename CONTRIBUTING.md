Contribute to Math.NET Filtering
================================
...
- Fork the [mainline repository](https://github.com/mathnet/mathnet-filtering) on GitHub ([how to](https://help.github.com/articles/fork-a-repo)).
