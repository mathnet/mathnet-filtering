...
namespace MathNet.Numerics
{
	...
	public static class Trig
	{
        ...
        /// <summary>Trigonometric Sine (Sinus) of an angle in radian</summary>
        public static double Sine(double radian)
        {
            return Math.Sin(radian);
        }
        /// <summary>Trigonometric Cosine (Cosinus) of an angle in radian</summary>
        public static double Cosine(double radian)
        {
            return Math.Cos(radian);
        }
        /// <summary>Trigonometric Tangent (Tangens) of an angle in radian</summary>
        public static double Tangent(double radian)
        {
            return Math.Tan(radian);
        }
        /// <summary>Trigonometric Cotangent (Cotangens) of an angle in radian</summary>
        public static double Cotangent(double radian)
        {
            return 1 / Math.Tan(radian);
        }
        /// <summary>Trigonometric Secant (Sekans) of an angle in radian</summary>
        public static double Secant(double radian)
        {
            return 1 / Math.Cos(radian);
        }
        /// <summary>Trigonometric Cosecant (Cosekans) of an angle in radian</summary>
        ...
        /// <summary>Trigonometric Arcus Sine (Arkussinus) in radian</summary>
        public static double InverseSine(double real)
        {
            return Math.Asin(real);
        }
        /// <summary>Trigonometric Arcus Cosine (Arkuscosinus) in radian</summary>
        public static double InverseCosine(double real)
        {
            return Math.Acos(real);
        }
        /// <summary>Trigonometric Arcus Tangent (Arkustangens) in radian</summary>
        public static double InverseTangent(double real)
        {
            return Math.Atan(real);
        }
        /// <summary>The principal argument (in radian) of the complex number x+I*y</summary>
        /// <param name="nominator">y</param>
        /// <param name="denominator">x</param>
        public static double InverseTangentFromRational(double nominator, double denominator)
        {
            return Math.Atan2(nominator, denominator);
        }
        /// <summary>Trigonometric Arcus Cotangent (Arkuscotangens) in radian</summary>
        public static double InverseCotangent(double real)
        {
            return Math.Atan(1 / real);
        }
        /// <summary>Trigonometric Arcus Secant (Arkussekans) in radian</summary>
        public static double InverseSecant(double real)
        {
            return Math.Acos(1 / real);
        }
        /// <summary>Trigonometric Arcus Cosecant (Arkuscosekans) in radian</summary>
        ...
        {
            return Math.Log(real + Math.Sqrt(real * real + 1), Math.E);
        }
        ...
        {
            return Math.Log(real + Math.Sqrt(real - 1) * Math.Sqrt(real + 1), Math.E);
        }
        ...
        {
            return Math.Log((1 + real) / (1 - real), Math.E) / 2;
        }
        ...
        {
            return Math.Log((real + 1) / (real - 1), Math.E) / 2;
        }
