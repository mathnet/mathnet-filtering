...
namespace MathNet.Numerics.LinearAlgebra
{
    ...
    public class Matrix : ICloneable
    {
        ...
        public Matrix(double[] vals, int m)
        {
            ...
            if(m * n != vals.Length)
            {
                throw new System.ArgumentException(string.Format(Resources.ArgumentVectorLengthsMultipleOf, "m"));
            }
        ...
        public virtual Matrix GetMatrix(int i0, int i1, int j0, int j1)
        {
            ...
            {
                throw new System.IndexOutOfRangeException(Resources.ArgumentMatrixIndexOutOfRange, e);
            }
            return X;
        }
        ...
        {
            if(diagonal == null) throw new ArgumentNullException("diagonal", string.Format(Resources.ArgumentNull, "diagonal"));
            if(diagonal.Length != RowCount) throw new ArgumentException(Resources.ArgumentMatrixSameDimensions);
        ...
        {
            if(B == null) throw new ArgumentNullException("B", string.Format(Resources.ArgumentNull, "B"));
        ...
        public static Matrix operator *(Matrix m1, Matrix m2)
        {
            ...
            {
                throw new System.ArgumentException(Resources.ArgumentMatrixSameDimensions);
            }
