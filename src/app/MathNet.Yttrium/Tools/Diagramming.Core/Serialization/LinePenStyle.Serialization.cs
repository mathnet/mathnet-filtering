...
namespace Netron.Diagramming.Core
{
    ...
    /// </summary>
   [Serializable]
    public partial class LinePenStyle : ISerializable, IXmlSerializable, IDeserializationCallback
    {
        ...
        protected LinePenStyle(SerializationInfo info, StreamingContext context)
            : base(info, context)     
        {
            
            if(Tracing.BinaryDeserializationSwitch.Enabled)
                Trace.WriteLine("Deserializing the fields of 'LinePenStyle'.");
            this.mStartCap = (LineCap)Enum.Parse(typeof(LineCap), info.GetString("StartCap"));
            this.mEndCap = (LineCap)Enum.Parse(typeof(LineCap), info.GetString("EndCap"));
        }
        #endregion
       ...
       */
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            //note that the generalization cap is defined as a static member in this class
            //
        ...
        {
            if(Tracing.BinaryDeserializationSwitch.Enabled)
                Trace.WriteLine("IDeserializationCallback of 'LinePenStyle' called.");
        }
    }
}
