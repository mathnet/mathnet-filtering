...
namespace Netron.Diagramming.Core
{
    ...
    /// </summary>
    [Serializable]
    public partial class DiagramEntityBase : ISerializable, IXmlSerializable, IDeserializationCallback
    {
        ...
        protected DiagramEntityBase(SerializationInfo info, StreamingContext context)
        {
            if(Tracing.BinaryDeserializationSwitch.Enabled)
                Trace.WriteLine("Deserializing the fields of 'DiagramEntityBase'.");
            ...
            this.mPaintStyle = info.GetValue("PaintStyle", typeof(IPaintStyle)) as IPaintStyle;
            this.mPenStyle = info.GetValue("PenStyle", typeof(IPenStyle)) as IPenStyle;
        ...
        */
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            if(Tracing.BinarySerializationSwitch.Enabled)
                Trace.WriteLine("Serializing the fields of 'DiagramEntityBase'.");
