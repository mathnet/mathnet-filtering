...
namespace Netron.Diagramming.Core
{
    ...
    /// </summary>
   [Serializable]
    public partial class SimpleShapeBase : ISerializable, IXmlSerializable, IDeserializationCallback
    {
        ...
        protected SimpleShapeBase(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {

            if(Tracing.BinaryDeserializationSwitch.Enabled)
                Trace.WriteLine("Deserializing the fields of 'SimpleShapeBase'.");
       ...
       */
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            if(Tracing.BinarySerializationSwitch.Enabled)
                Trace.WriteLine("Serializing the fields of 'SimpleShapeBase'.");
        ...
        public override void OnDeserialization(object sender)
        {
            ...
            if(Tracing.BinaryDeserializationSwitch.Enabled)
                Trace.WriteLine("IDeserializationCallback of 'SimpleShapeBase' called.");
        }
    }
}
