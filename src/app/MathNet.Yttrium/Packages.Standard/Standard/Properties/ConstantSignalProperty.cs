...
{
    public sealed class ConstantSignalProperty : PropertyBase
    {
        private static readonly MathIdentifier _customTypeId = new MathIdentifier("Constant", "Std");
        ...
        //{
        //}
        //private static ConstantSignalProperty InnerDeserialize(IContext context, XmlReader reader)
        //{
        //    return Instance;
        //}
        private static ConstantSignalProperty Deserialize(XmlReader reader, IDictionary<Guid, Signal> signals, IDictionary<Guid, Bus> buses)
        {
            return Instance;
        }
        #endregion
