...
{
    [Serializable]
    public abstract class AbstractPortSignalIndexCommand : CommandBase, ICommand
    {
        private CommandReference _signalRef, _portRef;
        private int _index;

        protected AbstractPortSignalIndexCommand() { }
        ...
        {
            reader.ReadStartElement("PortSignalIndexCommand", Context.YttriumNamespace);
        ...
        {
            writer.WriteStartElement("PortSignalIndexCommand", Context.YttriumNamespace);
