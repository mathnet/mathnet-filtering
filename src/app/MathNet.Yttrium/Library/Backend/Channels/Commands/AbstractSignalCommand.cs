...
{
    [Serializable]
    public abstract class AbstractSignalCommand : CommandBase, ICommand
    {
        private CommandReference _signalRef;

        protected AbstractSignalCommand() { }
        ...
        {
            reader.ReadStartElement("SignalCommand", Context.YttriumNamespace);
            _signalRef = CommandReference.Deserialize("Signal", reader);
            reader.ReadEndElement();
        }
        public virtual void WriteXml(XmlWriter writer)
        {
            writer.WriteStartElement("SignalCommand", Context.YttriumNamespace);
