...
namespace MathNet.Symbolics.StdPackage.Structures
{
    ...
    public sealed class NegativeInfinitySymbol : ValueStructure, IEquatable<NegativeInfinitySymbol>, IComparable<NegativeInfinitySymbol>
    {
        private static readonly MathIdentifier _structureId = new MathIdentifier("NegativeInfinity", "Std");
        ...
        public static void PublishConversionRouteNeighbors(StructureTable table)
        {
            ...
            table.AddStructure(_structureId, _router, typeof(NegativeInfinitySymbol));
        }
        public static NegativeInfinitySymbol ConvertFrom(ValueStructure value)
        {
            return _instance;
        }
        #endregion
        ...
        private static NegativeInfinitySymbol InnerDeserialize(Context context, System.Xml.XmlReader reader)
        {
