...
namespace MathNet.Symbolics.StdPackage.Structures
{
    ...
    //public class RealMatrixValue : ValueStructure, IEquatable<RealMatrixValue> //, IComparable<RealMatrixValue>
    //{
    //    private static readonly MathIdentifier _structureId = new MathIdentifier("RealMatrix", "Std");
    ...
    //    //}
    //    public static Signal Constant(Context context, Matrix value, string name)
    //    {
    ...
    //    public override ExtensionTypeXml Serialize(Context context)
    //    {
    ...
    //        //return xml;
    //    }
    //    public static new RealMatrixValue Deserialize(ExtensionTypeXml xml, Context context)
    //    {
    //        throw new NotImplementedException();
