...
{
    public sealed class RationalSetProperty : Property
    {
        private static readonly MathIdentifier _propertyId = new MathIdentifier("RationalSet","Std");
        ...
        public override bool StillValidAfterEvent(Signal signal)
        {
            if(signal.Value == null)
                return false;
            return RationalValue.Converter.CanConvertLosslessFrom(signal.Value);
        }
        ...
        private static RationalSetProperty InnerDeserialize(Context context, XmlReader reader)
        {
            return Instance;
        }
        #endregion
