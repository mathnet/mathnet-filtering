...
{
    public sealed class IntegerSetProperty : Property
    {
        private static readonly MathIdentifier _propertyId = new MathIdentifier("IntegerSet", "Std");
        ...
        private static IntegerSetProperty InnerDeserialize(Context context, XmlReader reader)
        {
            return Instance;
        }
        #endregion
